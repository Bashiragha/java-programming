...
public class ArraysAsList {
    public static void main(String[] args) {
        ...
        List <Integer> nums = Arrays.asList(23, 1, 34, 54, 654);// when we write asList then we can not add anything to it
        System.out.println("nums = " + nums);

       // nums.add(100); will not be added because of asList
        // nums.remove(0); will not be removed because of asList
        // nums.clear(); will not be clear because of asList
        ...
        List<String> drinksWithCaffeine = new ArrayList<>(Arrays.asList("coffee", "tea", "monster", "redbull", "coke", "pepsi",
